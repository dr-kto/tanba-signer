...
export default function PDFViewer({
  ...
  return (
    <div className="flex flex-1 overflow-hidden relative">
      ...
      {numPages > 1 && (
        <div className="absolute right-2 top-1/2 -translate-y-1/2 flex flex-col gap-1.5 bg-bg-card/80 backdrop-blur-sm rounded-xl p-1.5 border border-border z-10">
          {Array.from({ length: numPages }, (_, i) => (
            <button
              key={i}
